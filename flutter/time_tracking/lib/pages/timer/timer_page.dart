    ...
    children: <Widget>[
      Stack(
        ...
        children: <Widget>[
          ...
          ProgressIndicator(model.seconds, shortestSide * 0.6,
              shortestSide * 0.05, const Color(0xFF859DC1)),
          ProgressIndicator(model.minutes, shortestSide * 0.7,
              shortestSide * 0.05, const Color(0xFF82BDBF)),
          ProgressIndicator(model.hours, shortestSide * 0.8,
              shortestSide * 0.05, const Color(0xFFB8D6E1)),
...
@hwidget
Widget progressIndicator(BehaviorSubject<double> subject, double diameter,
